  ...
  const defaultSettings = [
    {
      ...
      value: {
        ...
        instanceName: process.env.EVOLUTION_INSTANCE || 'sedat2',
        instanceKey: process.env.EVOLUTION_API_KEY || 'CC3C74FD6208-4756-87F3-133CFA796603',
        globalApiKey: process.env.EVOLUTION_GLOBAL_KEY || '16f54b4d7f24e095e8e88761f3bc993d863cafced9d6f99939824',
